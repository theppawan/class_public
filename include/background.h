...
struct background
{
  ...
  double w0_jbp;   /**< \f$ w1_{DE} \f$: first fluid equation of state parameter for JBP parametrization */
  double w1_jbp;   /**< \f$ w2_{DE} \f$: second fluid equation of state parameter for JBP parametrization */
